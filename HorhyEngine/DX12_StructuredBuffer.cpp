...
#include "Engine.h"
#include "Render.h"
#include "DX12_StructuredBuffer.h"

using namespace D3D11Framework;

void DX12_StructuredBuffer::Release()
{
...
bool DX12_StructuredBuffer::Create(unsigned int elementCount, unsigned int elementSize)
{
...
void DX12_StructuredBuffer::Bind(unsigned short bindingPoint, unsigned short shaderType) const
{
	switch (shaderType)
	{
	case 0:
